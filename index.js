...
function GameBoyCore(canvas, ROMImage, opts) {
    ...
    this.previousBuffer = null     //imageData handle
...
GameBoyCore.prototype.initLCD = function () {
    ...
    try {
        ...
        this.previousBuffer = this.drawContextOffscreen.createImageData(this.offscreenWidth, this.offscreenHeight)
    }
    catch (error) {
    ...
    while (index > 0) {
        console.log('init    this.previousBuffer')
        this.previousBuffer.data[index -= 4] = 0xF8
        this.previousBuffer.data[index + 1] = 0xF8
        this.previousBuffer.data[index + 2] = 0xF8
        this.previousBuffer.data[index + 3] = 0xFF
    }
    this.graphicsBlit()
...
GameBoyCore.prototype.processDraw = function (frameBuffer) {
    ...
    // var pixel, i, j
    //
    // for (i = 0; i < this.offscreenWidth * this.offscreenHeight; i++) {
    //     pixel = frameBuffer[i]
    //     j = i * 4
    //     if (pixel !== this.previousBuffer[i]) {
    //         canvasData[j] = pixel & 0xFF
    //         canvasData[j + 1] = (pixel >> 8) & 0xFF
    //         canvasData[j + 2] = (pixel >> 16) & 0xFF
    //         this.previousBuffer[i] = pixel
    //     } else {
    //         canvasData[j] = 0
    //         canvasData[j + 1] = 0
    //         canvasData[j + 2] = 0
